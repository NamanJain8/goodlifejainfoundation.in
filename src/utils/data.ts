...
export const timelineData: TimelineItem[] = [
  {
    ...
    description: [
      'At the end of the Bhogabhumi era, when the Kalpavriksha deprived people of their desires and temptations; they sought help from the fourteenth Kulakara king, Nabhirayaji. He directed them to his son, Rishabhadeva, who possessed the tri-knowledge (Mati, Shrut, and Avadhi Jnana).',
  ...
  },
  {
    ...
    description: [
      'Among the six actions, Vidya (education) stands out as the most profound, expansive, and impactful. Rishabhdev, valuing its significance, taught Vidya not only to his 101 sons but also to his two daughters, treating them as equals to their brothers.',
      'As the Adi Vidhata (the First Preceptor), he emphasized to the public: "Unless women are educated, the next generation cannot be educated." Though challenging at first, his words were accepted as a royal decree. True to his teachings, Maharaj Rishabhdev Ji began this transformative initiative with his own daughters.'
    ],
  ...
  },
  {
    ...
    description: [
      'King Rishabhdev called upon his daughters, Brahmi and Sundari, as they approached adulthood and explained the vital role of education in one\'s life. He emphasized that an educated person is revered as a guide in society, while one without education is likened to an animal.',
      'Recognising the value of learning, Brahmi and Sundari, with great humility, requested their father to grant them the gift of knowledge and education. They aspired to enrich not only their own lives but also the lives of their loved ones through this wisdom.'
    ],
  ...
  },
  {
    ...
    description: [
      'Recognizing his daughters\' enthusiasm and readiness for education, King Rishabhdev began teaching them from an auspicious Nakshatra muhurat.',
      'To his elder daughter, Brahmi, he imparted the gift of Akshar Vidya (alphabetical knowledge) by seating her on his right side. To Sundari, seated on his left, he bestowed Ank Vidya (numerical knowledge).'
    ],
  ...
  },
  {
    ...
    description: [
      'Bhogabhumi existed until the third era, during which ten types of essential life items were effortlessly available to humans through the Kalpavriksha (wish-fulfilling trees).',
      'In this land, beings would obtain their desires simply by contemplating before these trees, without need for any effort. During this time, there were no friendships, relationships, or social connections of any kind.'
    ],
  ...
  },
  {
    ...
    description: [
      'Language serves as a means to express emotions and thoughts, while the art of writing language is known as a \'script\'. By the end of the third period, language had developed—specifically, the Prakrit language, regarded as the language of nature. In contrast, a refined and cultured language is known as Sanskrit.',
      'During this time, interaction occurred through Prakrit, but the language lacked a written form. Recognising this limitation, King Rishabhdev addressed it by teaching Lipi Vidya (the art of writing) to his elder daughter, Brahmi.'
    ],
  ...
  },
  {
    ...
    description: [
      'The natural language of human beings is called the Prakrit language. Its script was taught by King Rishabhdev to his daughter Brahmi, who then passed it onto others. For this reason, the script of the Prakrit language came to be known as Brahmi.',
      'King Rishabhdev taught Brahmi the art of writing by sitting on the right side, which is why 99% of the world\'s scripts are written from left to right. As the first script of this Avasarpini period, Brahmi has influenced all scripts that followed. A detailed study of these scripts reveals that they all stem from the Brahmi script.'
    ],
